...
public class TestHA3ChangeLeader extends AbstractHA3JournalServerTestCase  {
    ...
    public void testStartABC_ChangeLeader_RandomTrans() throws Exception {
    	...
    	try {
    		...
    		System.err.println("Problem with " + ntrans + " transactions");
    		throw e;
    	}
    }
    ...
    public void doStartABC_KillLeader(final int ntrans) throws Exception {
     ...
     */
    public void testStartABC_StressChangeLeader() throws Exception {
