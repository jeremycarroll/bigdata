...
class ServiceProxy implements ProcessManager, Administrable, Serializable {
                                                        ...
                                                        ClassNotFoundException
    {
        ...
        String errStr1 = "com.bigdata.process.ServiceProxy.readObject "
                         +"failure - ";
    ...
    private void readObjectNoData() throws InvalidObjectException {
        throw new InvalidObjectException
         ("No data found when attempting to deserialize "
          +"com.bigdata.process.ServiceProxy instance");
    }
}
