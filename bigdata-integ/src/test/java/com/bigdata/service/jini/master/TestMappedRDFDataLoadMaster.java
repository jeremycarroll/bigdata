 ...
 * @version $Id$
 */
public class TestMappedRDFDataLoadMaster  {
    ...
    public void test() throws ConfigurationException, InterruptedException,
        ...
        final File tempConfigFile = JiniServicesHelper
                .append(new File(DataFinder.bestPath("testing/data/com/bigdata/service/jini/master/TestMappedRDFDataLoadMaster.config") ) );

        final String[] args = new String[] {tempConfigFile.getPath()};
