...
//        final RuleStats stats = service.submit(task).get();
     ...
     */
    public Future<RuleStats> submit(DataService dataService) {
        ...
        return submitToConcurrencyManager(dataService);

    }

    private Future<RuleStats> submitToConcurrencyManager(DataService dataService) {
