...
class HybridProcessDescriptor extends BaseProcessDescriptor {

    public HybridProcessDescriptor(LauncherMain         launcher,
                                   ProcessConfiguration config)
    {
        super(launcher, config);
        if( !("hybrid".equals(config.cls)) ) {
    ...
    protected Process spawnProcess() throws IOException {
        ...
        // Add the Java system property definitions as command line arguments
        for( Map.Entry<String,String> ent :
