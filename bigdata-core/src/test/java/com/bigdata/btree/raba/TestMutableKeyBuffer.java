...
public class TestMutableKeyBuffer extends AbstractKeyBufferTestCase {
    ...
    public void test_mutation() {
        ...
        assertArrayEquals("prefix",new byte[]{},kbuf.getPrefix());
        ...
        assertArrayEquals(k1,kbuf.keys[0]);
        assertEquals("prefixLength",3,kbuf.getPrefixLength());
        assertArrayEquals("prefix",new byte[]{1,2,3},kbuf.getPrefix());
        ...
        assertFalse(kbuf.isFull());
        assertArrayEquals(k1,kbuf.keys[0]);
        assertArrayEquals(k2,kbuf.keys[1]);
        assertEquals("prefixLength",2,kbuf.getPrefixLength());
        assertArrayEquals("prefix",new byte[]{1,2},kbuf.getPrefix());
        ...
        assertArrayEquals(k1,kbuf.keys[0]);
        assertArrayEquals(k2,kbuf.keys[1]);
        assertArrayEquals(k3,kbuf.keys[2]);
        assertEquals("prefixLength",2,kbuf.getPrefixLength());
        assertArrayEquals("prefix",new byte[]{1,2},kbuf.getPrefix());
        ...
        assertEquals("nkeys",2,kbuf.nkeys);
        assertFalse(kbuf.isFull());
        assertArrayEquals(k2,kbuf.keys[0]);
        assertArrayEquals(k3,kbuf.keys[1]);
        ...
        assertNull(kbuf.keys[2]);
        assertEquals("prefixLength",3,kbuf.getPrefixLength());
        assertArrayEquals("prefix",new byte[]{1,2,4},kbuf.getPrefix());
        ...
        assertTrue(kbuf.isFull());
        assertArrayEquals(k1,kbuf.keys[0]);
        assertArrayEquals(k4,kbuf.keys[1]);
        assertArrayEquals(k2,kbuf.keys[2]);
        assertEquals("prefixLength",2,kbuf.getPrefixLength());
        assertArrayEquals("prefix",new byte[]{1,2},kbuf.getPrefix());
