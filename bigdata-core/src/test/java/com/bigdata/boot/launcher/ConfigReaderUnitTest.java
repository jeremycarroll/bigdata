...
//    @BeforeClass public static void initAll() {
    public static void initAll() {
        String logConfigFile = DataFinder.bestPath("var/config/logging/log4j.properties");
...
//    @Test(expected=IOException.class)
    ...
    public void testNonexistantFile() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                                   (new File(ROOT_DIR,"nonexistent.xml"),
                                    new ConfigurationPropertyMap());
        } catch(IOException e) {
            testPassed = true;
...
//    @Test(expected=SAXException.class)
    ...
    public void testMissingBootTag() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                               (new File(ROOT_DIR,"missingBootTag.xml"),
                                new ConfigurationPropertyMap());
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidTag() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                                   (new File(ROOT_DIR,"invalidTag.xml"),
                                    new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_boot_arg() throws Exception {
        ...
        try {
            ConfigReader rdr = 
            new ConfigReader
                    (new File(ROOT_DIR,"invalidNesting_boot_arg.xml"),
                     new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_boot_boot() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_boot_boot.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_javaprop_arg() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_javaprop_arg.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_javaprop_boot() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_javaprop_boot.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_javaprop_javaprop() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
              (new File(ROOT_DIR,"invalidNesting_javaprop_javaprop.xml"),
               new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_javaprop_process() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
              (new File(ROOT_DIR,"invalidNesting_javaprop_process.xml"),
               new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_javaprop_property() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
              (new File(ROOT_DIR,"invalidNesting_javaprop_property.xml"),
               new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_process_boot() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_process_boot.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_property_arg() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_property_arg.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_property_boot() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidNesting_property_boot.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_property_javaprop() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
              (new File(ROOT_DIR,"invalidNesting_property_javaprop.xml"),
               new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_property_process() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
               (new File(ROOT_DIR,"invalidNesting_property_process.xml"),
                new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidNesting_property_property() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
              (new File(ROOT_DIR,"invalidNesting_property_property.xml"),
               new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
//            throw e;
    ...
    public void testPropertyTag() throws Exception {
        ...
        testPassed = false;
        ConfigReader rdr = 
            new ConfigReader(new File(ROOT_DIR,"propertytest.xml"),
                             new ConfigurationPropertyMap());
        ConfigurationPropertyMap propMap = rdr.getBootPropertyMap();
        assertEquals
...
//    }
    ...
    public void testIncludeFile() throws Exception {
        ...
        testPassed = false;
        ConfigReader rdr = new ConfigReader
                               (new File(ROOT_DIR,"includeFile.xml"),
                                new ConfigurationPropertyMap());
        ConfigurationPropertyMap propMap = rdr.getBootPropertyMap();
    ...
    public void testIncludeNonexistentFile() throws Exception {
        ...
        testPassed = false;
        ConfigReader rdr = new ConfigReader
            (new File(ROOT_DIR,"includeNonexistentFile.xml"),
             new ConfigurationPropertyMap());
        ConfigurationPropertyMap propMap = rdr.getBootPropertyMap();
        assertTrue
    ...
    public void testIncludeNonexistentRequiredFile() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"includeNonexistentRequiredFile.xml"),
                 new ConfigurationPropertyMap());
        } catch(IOException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
//            throw e;
    ...
    public void testProcessTag() throws Exception {
        ...
        testPassed = false;
        ConfigReader rdr = 
            new ConfigReader(new File(ROOT_DIR,"processTagTest.xml"),
                             new ConfigurationPropertyMap());
    ...
    public void testInvalidProcessTag_missingTag() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidProcessTag_missingTag.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
...
//    @Test(expected=SAXException.class)
    ...
    public void testInvalidProcessTag_missingClass() throws Exception {
        ...
        try {
            ConfigReader rdr = new ConfigReader
                (new File(ROOT_DIR,"invalidProcessTag_missingClass.xml"),
                 new ConfigurationPropertyMap());
        } catch(SAXException e) {
            testPassed = true;
//uncomment when @TEST(expected) works
