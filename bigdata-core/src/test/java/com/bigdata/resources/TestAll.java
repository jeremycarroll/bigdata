...
//        TestViewSplitter.class,
       ...
       TestResourceManagerBootstrap.class,
       ...
       TestAddDeleteResource.class,
//        TestReleaseResources.class,
//        TestReleaseResources.TestReleaseFree.class,
       TestReleaseResourcesWithCopyNoRelease.class,
       TestReleaseResourcesWithCopyImmediateRelease.class,
       TestReleaseResourcesWithCopy_NonZeroMinReleaseAge.class
        } )
