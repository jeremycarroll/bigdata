...
public class LookupStarter extends Thread {
    ...
    private String lookupClasspath = new File(jiniLib,"reggie.jar").getPath();
    private String lookupImplName =
                                "com.sun.jini.reggie.TransientRegistrarImpl";
    // private String lookupConfig = new File(appHome,DataFinder.bestPath("testing/data/com/bigdata/service/jini/util/config/lookup.config" ) ).getAbsolutePath();
    private String lookupConfig = new File(appHome,"var/config/jini/lookup.config").getPath();
