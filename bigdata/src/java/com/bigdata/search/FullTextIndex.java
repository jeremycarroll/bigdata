 ...
 * @version $Id$
 */
public class FullTextIndex extends AbstractRelation implements ITextIndexer {

	final protected static transient Logger log = Logger
			.getLogger(FullTextIndex.class);
	
	public ITextIndexer getInstance(final IIndexManager indexManager,
			final String namespace, final Long timestamp,
			final Properties properties) 	{
		 if (namespace == null)
	            throw new IllegalArgumentException();
	                 return new FullTextIndex(indexManager,namespace,timestamp,properties);
