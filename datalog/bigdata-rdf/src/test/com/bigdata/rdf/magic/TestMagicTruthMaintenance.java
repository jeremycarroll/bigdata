...
/**
 * Test suite for {@link MagicTruthMaintenance}.
 * 
 ...
 * @version $Id$
 */
public class TestMagicTruthMaintenance extends AbstractInferenceEngineTestCase {

    /**
     * 
     */
    public TestMagicTruthMaintenance() {
        super();
    }
     ...
     * @param name
     */
    public TestMagicTruthMaintenance(String name) {
        super(name);
    }
    ...
    public void test_retractAll_01() {
        ...
        try {
            ...
            final TruthMaintenance tm = new MagicTruthMaintenance(inf);
...
//        URI d = new URIImpl("http://www.bigdata.com/d");
        ...
        try {
            ...
            final TruthMaintenance tm = new MagicTruthMaintenance(store
                    .getInferenceEngine());
...
//                assertionBuffer.add(c, sco, d );
             ...
             */
            {
                ...
                TruthMaintenance tmControlStore = new MagicTruthMaintenance(
...
//      URI rdfType = new URIImpl("http://www.bigdata.com/type");
        ...
        try {
            ...
            TruthMaintenance tm = new MagicTruthMaintenance(inf);
